...
ddbsa_fr1<- ddbsa_fr %>%  filter(!lexical_class=="other")
ddbsa_fr1$lexical_class <- fct_relevel(ddbsa_fr1$lexical_class, "nouns") 
pca_reg1_fr <- lm(aoa ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6, data=ddbsa_fr1) 
#summary(pca_reg1)
# R^2 = .321
