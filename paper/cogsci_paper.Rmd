...
CDI data were downloaded from the Wordbank database [@frank2017wordbank], including data from XYZ children acquiring American English and XYZ children for French. Age of acquisition estimates were calculated via the wordbankr package using the XYZ method.
...
We focus our analysis on the 674 words from the English CDI that we were able to identify in at least some of the corpora, and the comparable 470 words from the French CDI. For French, because of the presence of more complex morphology, CDI words were matched to related words in corpora via a stemmer. 
