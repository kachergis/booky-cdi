...
We focus our analysis on the `r length(unique(dddc$definition))` words from the English CDI and `r length(unique(dddc_fr$definition))` words from the French CDI that were present in at least one of the corpora. For French, because of the presence of more complex morphology, CDI words were matched to related words in corpora via a stemmer. 
