...
After characterizing the structure of the principle components of frequency from different sources in both English and French, we investigate how well these components predict children's early word learning, using aggregate MacArthur-Bates Communicative Development Inventories (CDI) data from Wordbank [@frank2017wordbank]. 
