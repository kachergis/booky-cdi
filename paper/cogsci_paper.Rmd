...
PC1 already explains the bulk of the variance (`r round(pc_imp_en[2,1],3)*100`% for English and `r round(pc_imp_fr[2,1],3)*100`% for French); and PC2-PC4 each only capture an additional 2-4% of the variance for both languages. Note that the signs of eigenvectors in PCA are arbitrary, and so for ease of interpretation, whever possible we describe findings in the positive direction.
...
fr_coef_list = c("PC1", "PC2", "LCverb","PC1:LCfunc") # "LCadj", "LCfunc",
...
#new_tab[2,4] = "now"
new_tab = rbind(c("LC","quack, yum, potty, woof, water"),
                  c("+PC1","can, no, cockadoodledoo, now, time"),
                  c("+PC2","yes, gas, don't, uhoh, no"),
                  c("+PC3","camping, bye, jeans, smile, babysitter"), 
                  c("+PC4","was, lot, lips, gonna, hafta"), 
                  c("+PC5","mommy, grrr, cockadoodledoo, tissue, babysitter"), 
                  c("+PC6","would, mine, does, my, could"))
new_tab %>% 
  kbl(caption = "Top 5 improved words when adding each PC.", booktabs=T)
```
...
In spite of this, the remaining prinicipal components in both languages picked up on consistent differences in both register and source.
