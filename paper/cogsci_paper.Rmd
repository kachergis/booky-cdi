...
#new_tab[2,4] = "now"
new_tab = rbind(c("Lang PC","Top 5 Words"),
                #c("EN LC","quack, yum, potty, woof, water"),
...
new_tab %>% 
  kbl(caption = "Top 5 words with improved prediction of AoA when adding each PC for English (EN) and French (FR)",align='c',  booktabs=T,linesep = "") %>%
