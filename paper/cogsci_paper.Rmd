...
```{r, fig.env = "figure", fig.pos = "H", fig.align='center', out.width = "\\textwidth", set.cap.width=T, num.cols.cap=1, fig.cap = "Word frequency correlations between different corpus sources for the matched CDI words in English (top) and French (bottom)."}
