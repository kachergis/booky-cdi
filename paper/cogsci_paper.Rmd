...
new_tab %>% 
  kbl(caption = "Top 5 words with improved prediction of AoA when adding each predictor, lexical category (LC) and PCs, for English (EN) and French (FR)",align='c',  booktabs=T,linesep = "") %>%
