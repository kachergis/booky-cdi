...
en_rot %>%
  kbl(caption = "English PC rotations and the proportion of variance (PVar) for each PC. The lowest values have black cells, and the highest values have orange cells.", digits=2, booktabs=T) %>%
