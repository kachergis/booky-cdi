...
#en2 <- manova(cbind(total_prod, total_not_prod) ~ age * mom_ed_num * (PC1 + PC2), data=en_dat)

#en3 <- manova(cbind(total_prod, total_not_prod) ~ age * mom_ed_num * (PC1 + PC2 + PC3), data=en_dat)

en4 <- manova(cbind(total_prod, total_not_prod) ~ age * mom_ed_num * (PC1 + PC2 + PC3 + PC4), data=en_dat)
...
# lm with proportions? we want to get coefficient values to report...
