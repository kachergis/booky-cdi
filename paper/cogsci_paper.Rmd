...
Indeed, higher measures of input quantity and quality have been found to relate to children's faster vocabulary growth, and to often be related to parents' SES [ @rowe2012longitudinal; @hoff2003specificity]. Socio-Economic Status is a composite concept and parental education is often used as the proxy of the parents' SES  [see @rowe2018understanding as an entry point to this literature]. For example, @hoff2003specificity compared the speech of low versus high SES American mothers, with SES defined based on education (college-educated versus high school). <!-- here -->
...
Question 3: How do input frequencies relate to SES?  We index SES using maternal education, a common proxy measure for SES. Young children from higher-SES households tend to have larger vocabulary [@fernald2013ses] and parents with higher-SES tend to report reading more to their young children than parents with lower SES. We examine whether different components of children's input frequency distribution interact with maternal education.
...
Next, we turned to the question of how well these frequency distributions predict English- and French-learning children's early word learning. 
<!--here-->
Child-directed speech has been claimed to present properties that would facilitate language acquisition and promote infants' attention to language [@golinkoff2015baby;@soderstrom2007beyond] when compared to adult-directed speech. We hypothesize that frequency distributions in child-directed speech could thus play a major role in predicting children's early word learning. There has been less evidence on the specific role of books and media in predicting early word learning. 
...
<!--here-->
Correlations between parental SES and children's language development are documented in a large body of litterature, and SES seems to be predictive of aspects of word learning [@hoff2003specificity].
...
These findings suggest that the vocabulary composition of children whose mothers are more highly-educated (a proxy for household SES) may be better predicted by the word frequencies seen in child-directed books, rather than those from child-directed speech. 
...
<!--here-->
Second, corpora of different sizes were used to represent the sources and registers for each language, and less data were available overall for French. Its small data size should be taking into account when generalizing the patterns. Differences we observed between the two languages could be partly attributed to differences in corpus size and sources. 
For example, the French corpora were composed of several smaller ones, due to the lack of large accessible corpora, and had slightly different makeup, e.g. short stories in French vs. longer books in English. 

<!--here-->
Third, most English and some French child-directed books have been published several decades ago, and were used in this study due to the lack of available open-source contemporary books. This may yield slightly different frequency distributions, however we expect that the difference for the specific CDI words tested here would be negligible. 
<!--here-->
Moreover, the difficulty of drawing conclusions about the results of this study should be considered, since the conclusions are based on interpretations of the relevant dimensions of the different principal components. Finally, although we made an effort to examine two languages, French and English represent only a tiny subset of the broader set of linguistic environments in which children acquire their vocabulary. 
