...
This model showed significant main effects of age ($\beta = 0.24$), mother's education (college grad+ $\beta = -1.03$), and all five PCs (all $p<.001$).
Faster learning was predicted for words with higher values on PC1 ($\beta=.10$), PC2 ($\beta=.45$), on PC4 ($\beta=.28$).
