...
en_rot %>%
  kbl(caption = "English PC rotations and proportion of variance (PVar) for each PC, colored by value (low=black; high=orange).", digits=2, booktabs=T) %>%
...
Faster learning was predicted for words with higher values on PC1 (overall frequency; $\beta=.10$), PC2 (child-directed speech; $\beta=.45$), or PC4 ( $\beta=.28$).
