...
pc_bsa$rotation %>%
  kbl(caption = "English principal component rotations.", digits=2) %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  column_spec(2, italic=T) %>% # PC1
  column_spec(3, bold=c(F,F,T,F,F,F), italic=c(F,F,F,F,T,F)) %>% # PC2
  column_spec(4, bold=c(F,F,F,F,F,T), italic=c(T,F,F,F,F,F)) %>%
  column_spec(5, bold=c(F,F,F,T,F,F), italic=c(F,T,F,F,F,F)) %>%
  column_spec(6, bold=c(F,T,F,F,F,F), italic=c(F,F,T,F,F,F)) %>%
  column_spec(7, bold=c(T,F,F,F,F,F), italic=c(F,F,F,T,F,F)) %>%
  kable_styling()
...
#pc_bsa_fr$rotation %>%
#    papaja::apa_table(digits=2, caption="French principal component rotations.", placement='h')    

pc_bsa_fr$rotation %>%
  kbl(caption = "French principal component rotations.", digits=2) %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  column_spec(2, italic=T) %>% # PC1
  column_spec(3, bold=c(F,F,T,F,F,F), italic=c(F,T,F,F,T,F)) %>% # PC2
  column_spec(4, bold=c(F,F,F,F,F,T), italic=c(F,F,T,F,F,F)) %>%
  column_spec(5, bold=c(T,F,F,F,F,F), italic=c(F,F,F,F,F,T)) %>%
  column_spec(6, bold=c(F,F,F,T,F,F), italic=c(T,F,F,F,F,F)) %>%
  column_spec(7, bold=c(F,T,F,F,F,F), italic=c(F,F,F,F,T,F)) %>%
  kable_styling()
```
