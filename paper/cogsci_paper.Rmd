...
EN = c("Freq:-.31...-.52", "ChS:.65; AdB:-.47", "AdS:.79; ChM:-.35", "M Ch:.40 A:.48; B  Ch:-.63 A:-.44", "ChS:-.60; ChB:.53", "ChM:.73; AdM:-.53"),
FR = c("Freq:-.39...-.44", "ChS:.63; AdB:-.67", "AdS:.67; ChM:-.68", "ChM:.55; ChS:-.63", "AdM:-.83; AdS:.50", "ChB:.79; AdB:.-56"))
...
French <- lm(aoa ~ (PC1 + PC2 + PC3 + PC4 + PC5 + PC6  + Nletters) * LC, data=ddbsa_fr_)
...
f<-coefplot(pca_lc6_fr, add=TRUE, col.pts="blue", coefficients = en_coef_list, vertical=TRUE, 
