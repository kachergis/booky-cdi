...
e<-coefplot(pca_lc6, coefficients=c("PC1","PC2","PC3","PC4","PC5", "LCfunc", "PC1:LCadj", "PC1:LCfunc", "PC1:LCother", "PC1:LCverb", "PC2:LCother", "PC2:LCverb", "PC3:LCfunc", "PC6:LCfunc"), vertical=TRUE, mar=c(5.5,2.5,2,2))
f<-coefplot(pca_lc6_fr, coefficients=c("PC1","PC2","PC3","PC4","PC5", "PC1:LCadj", "PC1:LCfunc", "PC1:LCother", "PC1:LCverb","PC2:LCverb", "PC5:LCfunc", "PC6:LCother"), vertical=TRUE, mar=c(5.5,2.5,2,2)) 
