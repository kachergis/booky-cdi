...
# make mom_ed numeric? 
m1 <- lmer(produces ~ age_sc + books_sc * mom_ed_sc + speech_sc * mom_ed_sc + (1|item_id) + (1|data_id), data=d_samp)
summary(m1)
anova(m1)
...
m2 <- lmer(produces ~ age_sc + lexical_class * books_sc * mom_ed_sc + lexical_class * speech_sc * mom_ed_sc + (1|item_id) + (1|data_id), data=d_samp)
summary(m2)
