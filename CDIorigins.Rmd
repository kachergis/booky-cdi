...
# make mom_ed numeric? 
m1 <- lmer(produces ~ age + books_sc * mom_ed + speech_sc * mom_ed + (1|item_id) + (1|data_id), data=d_samp)
summary(m1)
anova(m1)

m1p <- ggemmeans(m1, c("books_sc", "speech_sc", "mom_ed"))
plot(m1p)

m2 <- lmer(produces ~ age + lexical_class * books_sc * mom_ed + lexical_class * speech_sc * mom_ed + (1|item_id) + (1|data_id), data=d_samp)
summary(m2)
