...
```{r}
ch_freq <- ch_freq %>% left_join(d_en_ws %>% distinct(definition, lexical_class), by=c("word"="definition"))

ch_freq_smooth <- ch_freq_smooth %>% left_join(d_en_ws %>% distinct(definition, lexical_class), by=c("word"="definition"))
...
#save(aoas, file="data/AoAs_EN_American.Rds")
load("data/AoAs_EN_American.Rds")
